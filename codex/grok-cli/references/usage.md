...
grok -V
grok models
./scripts/grok-headless-clean.sh --prompt "Reply with exactly: OK"
```
...
- Default fallback directory is `/home/deck`.
...
- Codex `web` for plain web research
- Codex local coding tools for edits, diffs, and test loops
